...
|[AB тестирование]()| Приоритизация гипотез для увеличения выручки интернет-магазина, запуск A/B-теста и анализ его результатов.| pandas, numpy, matplotlib.pyplot, scipy.stats |
